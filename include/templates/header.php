...
<body>
    <header class="header">
        <section id="main-header" class="m-0 p-0" style="width: 100%; height: 300px; background-image: url('../../img/header.png'); background-size: cover; background-position: center;">
        </section>
    </header>
    ...
    <nav class="navbar navbar-expand-md p-0 " style="background-color: #475a68; z-index: 1;">
        <div class="container-fluid">
            ...
            <a class="navbar-brand m-0 py-0 pl-4 pr-2" href="index.php">
                <img src="../../img/logo.png" class="img-responsive" alt="Responsive image" width="94" height="94" />
            </a>
                ...
                <ul class="navbar-nav" style="font-size:1.5rem; padding: 0;">
                    ...
                    <li class="nav-item px-3 py-4">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu shadow" style="border-radius: 0; border: none; background-color: #eee;" aria-labelledby="dropdownMenuLink">
